      ...
      <main className='prose prose-headings:text-foreground prose-a:text-foreground prose-strong:text-foreground mx-5 text-foreground'>
        ...
        <article>
          ...
          <p>
            ...
            referred to as the &quot;Products&quot;) provided by Retroloop under any ongoing
          ...
          <p>
            ...
            usual&quot;, as per our offer schedule. If your use is considered to be excessive, then
          ...
          <p>
            ...
            customers and, where applicable, their users (&quot;end-users&quot;) to likewise engage
          ...
          <p>
            ...
            actions of anyone using our Products with the customer&apos;s permission. This
            responsibility also applies to anyone using our Products on an unauthorized basis as a
            result of the customer&apos;s failure to put in place reasonable security measures.
          </p>
          <p>
          ...
          <p>
            ...
            (“spam”). This includes but isn&apos;t limited to sending spam, soliciting customers
            from spam sent from other service providers, and collecting replies to spam sent from
            other service providers.
          </p>
          <p>
            Our Products must not be used for the purpose of running unconfirmed mailing lists or
            telephone number lists (&quot;messaging lists&quot;). This includes but isn&apos;t
            limited to subscribing email addresses or telephone numbers to any messaging list
            without the permission of the email address or telephone number owner, and storing any
            email addresses or telephone numbers subscribed in this way. All messaging lists run on
            or hosted by our Products must be &quot;confirmed opt-in&quot;. Verification of the
          ...
          <p>
            ...
            customer&apos;s behalf, that directly or indirectly refer the recipient to a site hosted
            via our Products.
          </p>
          ...
          <p>
            ...
            includes but isn&apos;t limited to facilitating the means to send spam and the
            initiation of network sniffing, pinging, packet spoofing, flooding, mail-bombing and
          ...
          <p>
            ...
            access the resource (e.g. &quot;hacking&quot;, &quot;cracking&quot;,
            &quot;phreaking&quot;, etc.).
          </p>
          <p>
