    ...
    <ThemeProvider attribute='class' enableColorScheme={true} enableSystem={true}>
      <QueryClientProvider client={queryClient}>
        <PlausibleProvider domain='retroloop.io' customDomain='stats.retroloop.io'>
          ...
          >
            <div className='opacity-gradient pattern-dots absolute -z-50 h-full min-h-screen w-screen pattern-bg-transparent pattern-foreground pattern-opacity-5 pattern-size-4' />
            <MenuBar />
            <Component {...pageProps} />
          </div>
        </PlausibleProvider>
