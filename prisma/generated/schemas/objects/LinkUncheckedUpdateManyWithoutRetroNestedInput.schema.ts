...
const Schema: z.ZodType<Prisma.LinkUncheckedUpdateManyWithoutRetroNestedInput> = z
  .object({
    create: z
      .union([
...
export const LinkUncheckedUpdateManyWithoutRetroNestedInputObjectSchema = Schema
