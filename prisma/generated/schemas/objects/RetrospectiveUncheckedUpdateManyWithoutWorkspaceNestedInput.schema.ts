...
const Schema: z.ZodType<Prisma.RetrospectiveUncheckedUpdateManyWithoutWorkspaceNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetrospectiveUncheckedUpdateManyWithoutWorkspaceNestedInputObjectSchema = Schema
