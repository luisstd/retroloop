...
const Schema: z.ZodType<Prisma.RetroItemUpdateManyWithoutItemCollectionNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemUpdateManyWithoutItemCollectionNestedInputObjectSchema = Schema
