...
const Schema: z.ZodType<Prisma.RetrospectiveUpdateManyWithoutItemCollectionsNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetrospectiveUpdateManyWithoutItemCollectionsNestedInputObjectSchema = Schema
