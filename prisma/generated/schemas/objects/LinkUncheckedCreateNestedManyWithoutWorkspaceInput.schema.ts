...
const Schema: z.ZodType<Prisma.LinkUncheckedCreateNestedManyWithoutWorkspaceInput> = z
  .object({
    create: z
      .union([
...
export const LinkUncheckedCreateNestedManyWithoutWorkspaceInputObjectSchema = Schema
