...
const Schema: z.ZodType<Prisma.RetrospectiveCreateNestedManyWithoutWorkspaceInput> = z
  .object({
    create: z
      .union([
...
export const RetrospectiveCreateNestedManyWithoutWorkspaceInputObjectSchema = Schema
