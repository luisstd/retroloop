...
const Schema: z.ZodType<Prisma.RetroItemUncheckedCreateNestedManyWithoutRetrospectiveInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemUncheckedCreateNestedManyWithoutRetrospectiveInputObjectSchema = Schema
