...
const Schema: z.ZodType<Prisma.WorkspaceUncheckedCreateNestedManyWithoutOwnerInput> = z
  .object({
    create: z
      .union([
...
export const WorkspaceUncheckedCreateNestedManyWithoutOwnerInputObjectSchema = Schema
