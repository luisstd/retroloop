...
const Schema: z.ZodType<Prisma.RetroItemUncheckedUpdateManyWithoutRetrospectiveNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemUncheckedUpdateManyWithoutRetrospectiveNestedInputObjectSchema = Schema
