...
const Schema: z.ZodType<Prisma.RetrospectiveUncheckedCreateNestedManyWithoutItemCollectionsInput> =
  z
    .object({
      create: z
        .union([
...
export const RetrospectiveUncheckedCreateNestedManyWithoutItemCollectionsInputObjectSchema = Schema
