...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutRetrospectivesInput> = z
  .object({
    create: z
      .union([
...
export const UserUncheckedCreateNestedManyWithoutRetrospectivesInputObjectSchema = Schema
