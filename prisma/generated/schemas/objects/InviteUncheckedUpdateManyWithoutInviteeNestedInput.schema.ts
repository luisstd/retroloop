...
const Schema: z.ZodType<Prisma.InviteUncheckedUpdateManyWithoutInviteeNestedInput> = z
  .object({
    create: z
      .union([
...
export const InviteUncheckedUpdateManyWithoutInviteeNestedInputObjectSchema = Schema
