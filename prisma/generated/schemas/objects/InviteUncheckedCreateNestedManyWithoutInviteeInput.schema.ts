...
const Schema: z.ZodType<Prisma.InviteUncheckedCreateNestedManyWithoutInviteeInput> = z
  .object({
    create: z
      .union([
...
export const InviteUncheckedCreateNestedManyWithoutInviteeInputObjectSchema = Schema
