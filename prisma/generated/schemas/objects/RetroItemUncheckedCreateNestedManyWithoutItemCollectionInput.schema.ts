...
const Schema: z.ZodType<Prisma.RetroItemUncheckedCreateNestedManyWithoutItemCollectionInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemUncheckedCreateNestedManyWithoutItemCollectionInputObjectSchema = Schema
