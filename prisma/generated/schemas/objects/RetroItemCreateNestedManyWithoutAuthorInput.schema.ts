...
const Schema: z.ZodType<Prisma.RetroItemCreateNestedManyWithoutAuthorInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemCreateNestedManyWithoutAuthorInputObjectSchema = Schema
