...
const Schema: z.ZodType<Prisma.RetrospectiveCreateNestedManyWithoutParticipantsInput> = z
  .object({
    create: z
      .union([
...
export const RetrospectiveCreateNestedManyWithoutParticipantsInputObjectSchema = Schema
