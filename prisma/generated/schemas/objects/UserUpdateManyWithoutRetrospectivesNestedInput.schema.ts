...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutRetrospectivesNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserUpdateManyWithoutRetrospectivesNestedInputObjectSchema = Schema
