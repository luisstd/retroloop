...
const Schema: z.ZodType<Prisma.RetroItemUncheckedUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetroItemUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema = Schema
