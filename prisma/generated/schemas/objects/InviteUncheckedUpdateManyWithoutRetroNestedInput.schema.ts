...
const Schema: z.ZodType<Prisma.InviteUncheckedUpdateManyWithoutRetroNestedInput> = z
  .object({
    create: z
      .union([
...
export const InviteUncheckedUpdateManyWithoutRetroNestedInputObjectSchema = Schema
