...
const Schema: z.ZodType<Prisma.ItemCollectionUpdateManyWithoutRetrospectivesNestedInput> = z
  .object({
    create: z
      .union([
...
export const ItemCollectionUpdateManyWithoutRetrospectivesNestedInputObjectSchema = Schema
