...
const Schema: z.ZodType<Prisma.RetrospectiveUpdateManyWithoutParticipantsNestedInput> = z
  .object({
    create: z
      .union([
...
export const RetrospectiveUpdateManyWithoutParticipantsNestedInputObjectSchema = Schema
