...
const Schema: z.ZodType<Prisma.WorkspaceUncheckedUpdateManyWithoutOwnerNestedInput> = z
  .object({
    create: z
      .union([
...
export const WorkspaceUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema = Schema
