...
const Schema: z.ZodType<Prisma.ItemCollectionCreateNestedManyWithoutRetrospectivesInput> = z
  .object({
    create: z
      .union([
...
export const ItemCollectionCreateNestedManyWithoutRetrospectivesInputObjectSchema = Schema
