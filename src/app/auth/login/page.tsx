    ...
    <section className='flex flex-1 items-center justify-center'>
      <Card className='mx-5 sm:mx-0 sm:max-w-lg'>
        <Card.Header className='p-6 pb-4'>
          ...
          <Card.Description>Get started in seconds</Card.Description>
        </Card.Header>
        <Card.Content className='flex flex-col items-center gap-4 p-6 pt-4'>
          <div className='mx-auto flex w-full flex-col justify-between gap-3 sm:flex-row sm:gap-4'>
            <Button
              variant='outline'
              size='lg'
              onClick={async () => {
