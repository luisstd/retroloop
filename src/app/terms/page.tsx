export default function Terms() {
  return (
    <article>
      ...
      <p className='italic'>
        The website <span className='font-bold'>retroloop.io</span> is an
        official website of Noisia Labs OÜ, a company duly established and
        existing under the laws of the Republic of Estonia, registry code
        16847684, address Sepapaja tn 6, Tallinn, Harju county 15551, Estonia.
      </p>
      <p>
        These Terms of Service govern your use of the website located at{' '}
        <a href='https://retroloop.io'>https://retroloop.io</a> and any related
        services provided by Noisia Labs OÜ.
      </p>
      <p>
        By accessing <a href='https://retroloop.io'>https://retroloop.io</a>,
        ...
        using any other services provided by Noisia Labs OÜ.
      </p>
      <p>
        We, Noisia Labs OÜ, reserve the right to review and amend any of these
      ...
      <p>These Terms of Service were last updated on February 19, 2025.</p>
      ...
      <ul>
        ...
        <li>
          ...
          service Noisia Labs OÜ provides;
        </li>
        <li>
      ...
      <p>
        ...
        owned by or licensed to Noisia Labs OÜ and are protected by applicable
      ...
      <p>
        ...
        restrictions or the Terms of Service, and may be terminated by Noisia
        Labs OÜ at any time.
      </p>
      <h3>Liability</h3>
      <p>
        Our website and the materials on our website are provided on an &apos;as
        is&apos; basis. To the extent permitted by law, Noisia Labs OÜ makes no
      ...
      <p>
        In no event shall Noisia Labs OÜ or its suppliers be liable for any
        ...
        on this website, even if Noisia Labs OÜ or an authorized representative
      ...
      <p>
        ...
        general information purposes only. Noisia Labs OÜ does not warrant or
      ...
      <h3>Links</h3>
      <p>
        Noisia Labs OÜ has not reviewed all of the sites linked to its website
        and is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement, approval or control by
        Noisia Labs OÜ of the site. Use of any such linked site is at your own
      ...
      <p>
        ...
        provided by Noisia Labs OÜ under any ongoing agreement. It&apos;s
        designed to protect us, our customers and the general Internet community
        from unethical, irresponsible and illegal activity.
      </p>
      <p>
        Noisia Labs OÜ customers found engaging in activities prohibited by this
      ...
      <p>This policy was last reviewed on February 19, 2025.</p>
      <h3>Fair use</h3>
      <p>
      ...
      <p>
        ...
        their users (&quot;end-users&quot;) to likewise engage our Products with
        similar intent.
      </p>
      ...
      <p>
        ...
        applicable to your jurisdiction (&ldquo;spam&rdquo;). This includes but
        isn&apos;t limited to sending spam, soliciting customers from spam sent
        from other service providers, and collecting replies to spam sent from
      ...
      <p>
        ...
        or hosted by our Products must be &quot;confirmed opt-in&quot;.
      ...
      <p>
        ...
        isn&apos;t limited to facilitating the means to send spam and the
      ...
      <ol>
        ...
        <li>
          ...
          depict a violent act, depict child pornography or threaten
      ...
      <h4>Unauthorized use of Noisia Labs OÜ property</h4>
      <p>
        We prohibit the impersonation of Noisia Labs OÜ, the representation of a
        significant business relationship with Noisia Labs OÜ, or ownership of
        any Noisia Labs OÜ property (including our Products and brand) for the
