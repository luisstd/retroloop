      ...
      <main className='prose mx-5 text-foreground prose-headings:text-foreground prose-a:text-foreground prose-strong:text-foreground'>
        <article>
          ...
          <p>
            ...
            <a href='https://retroloop.io'>https://retroloop.io</a> and any
            related services provided by Retroloop.
          </p>
          <p>
            ...
            website or using any other services provided by Retroloop.
          </p>
          <p>
            We, Retroloop, reserve the right to review and amend any of these
          ...
          <p>These Terms of Service were last updated on 29 October 2023.</p>
          ...
          <ul>
            ...
            <li>
              ...
              other service Retroloop provides;
            </li>
            <li>
          ...
          <p>
            ...
            are owned by or licensed to Retroloop and are protected by
          ...
          <p>
            ...
            Retroloop at any time.
          </p>
          <h3>Liability</h3>
          <p>
            Our website and the materials on our website are provided on an
            &apos;as is&apos; basis. To the extent permitted by law, Retroloop
          ...
          <p>
            In no event shall Retroloop or its suppliers be liable for any
            ...
            materials on this website, even if Retroloop or an authorized
          ...
          <p>
            ...
            for general information purposes only. Retroloop does not warrant or
          ...
          <h3>Links</h3>
          <p>
            Retroloop has not reviewed all of the sites linked to its website
            and is not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement, approval or
            control by Retroloop of the site. Use of any such linked site is at
        ...
        <article>
          ...
          <p>This policy was last reviewed on 29 October 2023.</p>
          <h3>Fair use</h3>
          <p>
            We provide our facilities with the assumption your use will be
            &quot;business as usual&quot;, as per our offer schedule. If your
          ...
          <p>
            ...
            applicable, their users (&quot;end-users&quot;) to likewise engage
          ...
          <p>
            ...
            applicable to your jurisdiction (“spam”). This includes but
            isn&apos;t limited to sending spam, soliciting customers from spam
            sent from other service providers, and collecting replies to spam
            sent from other service providers.
          </p>
          <p>
            Our Products must not be used for the purpose of running unconfirmed
            mailing lists or telephone number lists (&quot;messaging
            lists&quot;). This includes but isn&apos;t limited to subscribing
            email addresses or telephone numbers to any messaging list without
            the permission of the email address or telephone number owner, and
            ...
            &quot;confirmed opt-in&quot;. Verification of the address or
            telephone number owner&apos;s express permission must be available
          ...
          <p>
            ...
            that directly or indirectly refer the recipient to a site hosted via
            our Products.
          </p>
          ...
          <p>
            ...
            includes but isn&apos;t limited to facilitating the means to send
          ...
          <h4>Unauthorized use of Retroloop property</h4>
          <p>
            We prohibit the impersonation of Retroloop, the representation of a
            significant business relationship with Retroloop, or ownership of
            any Retroloop property (including our Products and brand) for the
