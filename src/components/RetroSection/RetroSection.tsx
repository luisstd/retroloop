...
import RetroDialog, { RetrospectiveInput } from '@/components/RetroSection/components/RetroDialog'
...
export default function RetroSection(props: RetroSectionProps) {
  ...
  return (
    <div className='flex items-center w-screen h-full max-w-screen-2xl'>
      <section className='relative w-full h-full p-10 mx-5 border-2 border-black rounded-md dark:border-neutral-200 bg-base-light dark:bg-base-dark'>
